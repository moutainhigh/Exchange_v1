...
import com.brightoilonline.c2b_phone.BuildConfig;
import com.brightoilonline.c2b_phone.R;
import com.brightoilonline.c2b_phone.bean.OperaBean;
...
public class LogUtil {
	...
	/** 是否显示日志 */
	public static final boolean IS＿SHOW_LOG = BuildConfig.DEBUG;
	/** 异常 信息获取 */
