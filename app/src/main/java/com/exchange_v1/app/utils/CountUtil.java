...
public class CountUtil {
    ...
    public static void sendDataForStatistics(Context context, String registerId, HashMap<String, String> data, int count) {
        if (!isDebug) {
            ...
            StatService.onEvent(context, registerId, getChannelName(context), count, data);
        }
    }
    ...
    public static void sendDataForStatistics(Context context, String registerId, String data, int count) {
        if (!isDebug) {
            if (!TextUtils.isEmpty(data)) {
                ...
                StatService.onEvent(context, registerId, getChannelName(context), count);
            }
        }
    }
...
//            LogUtil.i("CU-->  productName:"+productName);
//        }
//        if (!StringUtil.isEmpty(productID)){
//            data.put("productID",productID);
//            LogUtil.i("CU-->  productID:"+productID);
//        }
//        if (!StringUtil.isEmpty(orderAmount)){
//            data.put("orderAmount",orderAmount);
//            LogUtil.i("CU-->  orderAmount:"+orderAmount);
//        }
//        if (!StringUtil.isEmpty(payway)){
//            data.put("payway",payway);
//            LogUtil.i("CU-->  payway:"+payway);
//        }

        SystemBiz.postC2bCount(context, data, new MyRequestHandle() {
            @Override
