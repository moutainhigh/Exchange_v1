...
//import com.exchange_v1.BuildConfig;
...
//			});
//		}
//		//此代码主要为了注解反射机制 找到 view
//		try {
//			autoInjectAllField(thisA);
...
//		//ToastUtil.showToast(context, this.getClass().toString());
...
//
////	/**
////	 * isLoadBackBtn 通常isLoadBackBtn为true，这里都为true
////	 * @return
////     */
////	private boolean isLoadAndroidManifestTitle() {
////		return isLoadBackBtn();
////	}
//
...
//
////			LogUtil.out("BaseActivity--lockTime:" + (System.currentTimeMillis() - TApplication.getOutTime()));
//			//当前时间戳 - 上次切换到后台的时间戳
//			if ((System.currentTimeMillis() - TApplication.getOutTime()) > TApplication.lockTime){//大于10分钟，则弹出手势密码界面
//				boolean isAutoLogin = GestureUtil.getIsAutoString(getString(R.string.spkey_value_gestrue_autologin), false);
//				String token = TApplication.getToken();
//				if (!StringUtil.isEmpty(token)){
//					IntentUtil.gotoActivity(this, GestureActivity.class);
//				}
//			}
//		}
//	}
...
//
//
//		if (thisA instanceof AddLoadingActivity || thisA instanceof LoadingActivity) {
//			return;
//		}
//
...
//
//				DialogV273 dialog =new DialogV273(thisA);
...
//
//
////				DialogUtil.showMessageDgBtnNoBg(thisA
////						, jPushTitle
////						, jPushMsg
////						, "我知道了"
...
//			//保存切换到后台时的时间戳
//			TApplication.setOutTime(System.currentTimeMillis());
//
//			isBack = true;
...
//	}
//     /**反射访问私有成员变量，自动findbyid*/
//	protected void autoInjectAllField(Activity activity) throws IllegalAccessException, IllegalArgumentException {
//		Class cls = activity.getClass();
//		Field[] fields = cls.getDeclaredFields();
//		for (Field field : fields) {
//			if (field.isAnnotationPresent(IndectView.class)) {//判断成员变量是否被标注
//				IndectView inject = field.getAnnotation(IndectView.class);
//				int id = inject.value();
//				if(id>0){
//					//反射访问私有成员变量,必须加上这句
...
//	}
//
//	public String getLastPayAmountStr(double originalCountPrice, CouponLogic couponLogic, GoilamountLogic goilamountLogic) {
//		return String.valueOf(getLastPayAmount(originalCountPrice,couponLogic,goilamountLogic));
//	}
//	public double getLastPayAmount(double originalCountPrice, CouponLogic couponLogic, GoilamountLogic goilamountLogic) {
//		double lastPayAmount = originalCountPrice;
//		if (goilamountLogic != null) {
//			lastPayAmount = goilamountLogic.getPriceHasCouponAndOilDiscount(originalCountPrice, couponLogic);
//		}else{
//			lastPayAmount = couponLogic.getPriceHasCoupon(originalCountPrice);
//		}
//		if (lastPayAmount <= 0) {
//			lastPayAmount = 0;
//		}
